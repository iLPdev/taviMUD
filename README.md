...
Project Link: [https://github.com/iLPdev/taviMUD]
...
- [Evennia](https://github.com/evennia/evennia) is an open-source Python-based framework, codebase and server for creating text-based multiplayer online games (aka MUD/MU* etc) using modern technologies and tools.
...
- **Project State**: taviMUD is under the planning stage of development.
...
The taviMUD project is [hosted on GitHub](https://github.com/iLPdev/taviMUD). All versions of the repository will be available as [releases](https://github.com/iLPdev/taviMUD/releases).

You can also clone the entire project directly with this command: `git clone git@github.com:iLPdev/taviMUD.git`
...
Contributions are what make the open source community such an amazing space to be learn, inspire, and create. Any contributions you make are **greatly appreciated** -- that’s the main reason taviMUD is open-sourced! There are so many ways to contribute, even if you’re not a technical person. All contributions--no matter how small---are always welcome. Adding an independent CONTRIBUTING.md remains on a to-do on my list.

Join the [discussion](https://github.com/iLPdev/taviMUD/discussions) for a list of ideas and questions.

See [open issues](https://github.com/iLPdev/taviMUD/issues) for proposed features, and known issues.

There is not yet an explicit workflow requirement for this project, but I'm probably returning to my hybrid [Gitflow](https://nvie.com/posts/a-successful-git-branching-model/) approach and [Conventional Commits](https://www.conventionalcommits.org/)... but you don't need to.
...
Copyleft (2020) _iLP development_. Distributed under AGPL v3.0-and-later. For more
information, see license in [`COPYING`](https://github.com/iLPdev/taviMUD/blob/master/COPYING).

**[^Top](#table-of-contents)**

<!-- MARKDOWN LINKS & IMAGES -->
<!-- https://www.markdownguide.org/basic-syntax/#reference-style-links -->
[contributors-shield]: https://img.shields.io/github/contributors/iLPdev/taviMUD.svg?style=flat-square
[contributors-url]: https://github.com/iLPdev/taviMUD/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/iLPdev/taviMUD.svg?style=flat-square
[forks-url]: https://github.com/iLPdev/taviMUD/network/members
[stars-shield]: https://img.shields.io/github/stars/iLPdev/taviMUD.svg?style=flat-square
[stars-url]: https://github.com/iLPdev/taviMUD/stargazers
[issues-shield]: https://img.shields.io/github/issues/iLPdev/taviMUD.svg?style=flat-square
[issues-url]: https://github.com/iLPdev/taviMUD/issues
[license-shield]: https://img.shields.io/github/license/iLPdev/taviMUD.svg?style=flat-square
[license-url]: https://github.com/iLPdev/taviMUD/blob/master/LICENSE.md
